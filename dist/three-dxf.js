...
THREE.BulgeGeometry = function (startPoint, endPoint, bulge, segments) {
  ...
  this.startPoint = p0 = startPoint ? new THREE.Vector3(startPoint.x, startPoint.y, 0) : new THREE.Vector3(0, 0, 0)
  this.endPoint = p1 = endPoint ? new THREE.Vector3(endPoint.x, endPoint.y, 0) : new THREE.Vector3(1, 0, 0)
...
(function (ThreeDxf) {
   ...
   * @constructor
   */
  ThreeDxf.Viewer = function (data, parent, opt = DEFAULT_OPT, cEvents = {}) {
    var $parent = $(parent)
    ...
    /*
     * @param formula [Array<Array<Float> >] 係数行列A: num x num 行列
    ...
    function drawSolid(entity, data) {
      var material, mesh, verts, geometry = new THREE.Geometry()
